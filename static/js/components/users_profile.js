...
const user_profile = {
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-8 col-lg-9">
            <div class="box">
                <h2 class="boxTitle">%{profile_user['fname']}'s Profile</h2>
                <!-- Tabs -->
                ...
                <div class="tab-content">
                        ...
                        <div class="userProfileContent">
                            <div class="i">
                                ...
                                <h2 class="boxHeadline">
                                    <p>Name: %{profile_user['fname']} %{profile_user['lname']}</p>
                                    <br>
                                    <p>Profession: %{profile_user['profession']}</p>
                                    <br>
                                    <p>Location: %{profile_user['location']}</p>
                                    <br>
                                    <p>Email ID: <a :href="profile_user['email']" title="e-mail">&nbsp;%{profile_user['email']}</a> </p>
                                    <br>
                                    <p>Last Logout Time: %{profile_user['timestamp']} </p>   
                                </h2>
                    ...
                    <div role="tabpanel" class="tab-pane fade active in" id="tab-item-2" style="width:100%">
                        <div class="userActivities" >
                            <p v-if="!blogs[0].length"><strong>No Blogs Found...</strong></p>
                                ...
                                <div class="activityContent">
                                    ...
                                    <ul class="simpleListings status" >
                                        <li>
                                            ...
                                            <span v-if="profile_user['id']===current_user_id">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tab-item-3">
                        ...
                        <div class="connections row gx-3 mb-3">
                            <table class="col-md-6" style="border-right: 2px solid gray;">
                                <thead>
                                <tr>
                                    <th>Followers (%{profile_user['total_followers']})</th>
                                    ...
                                    <tr v-for="i in total_followers_all"  class="candidates-list">
                                        ...
                                        <td class="col-sm-4">
                                            <ul>                                     
                                                ...
                                                <button @click="user_profile(i.username)" >Visit Profile</button>
                            ...
                            <table class="col-md-6" style="border-left: 2px solid gray; margin-left: -2px;">
                                <thead>
                                <tr>
                                    <th>Following (%{profile_user['total_following']})</th>
                                    <th class="action">Action</th>
                                </tr>
                                </thead>
                                <tbody>
       ...
       methods: {
        ...
        like(blogId) {  
            ...
            fetch('/like_post/'+localStorage.getItem('username')+"/" + blogId, { method: "POST" })
                .then((res) => res.json())
                .then((data) => {
        ...
        follow(profile_user_username){
            fetch("/following/"+localStorage.getItem('username')+'/'+profile_user_username, {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json'
              },
          ...
          unfollow(profile_user_username){
            fetch("/followers/"+localStorage.getItem('username')+'/'+profile_user_username, {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json'
              },
